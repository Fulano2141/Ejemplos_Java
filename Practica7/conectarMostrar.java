...
public class conectarMostrar {
    ...
    private static String bd = "Ejercicio2"; // Nombre de BD.
    ...
    public static void main(String[] args) throws SQLException {
        ...
        cadena = "INSERT INTO producto (`Identificador`, `Nombre`, `Tipo`, `Procedencia`, `FechaExpiracion`) VALUES "
        		+ "(1, 'Licuadora', 'Electrodomestico', 'USA', 'NINGUNA'), "
