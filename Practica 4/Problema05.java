/* 5.- Un arreglo contiene las estaturas en cm de n personas, determinar 
 * la mayor estatura, la estatura más baja y el promedio de estaturas.*/
import javax.swing.*;
import java.util.*;
class Problema05{
  ...
  public static void main (String [] Fulano){
    ...
    int con1=0, menor=10000,a=0,con2=0, menr=0,b=0,pro=0;
