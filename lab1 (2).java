...
public class lab1 {
	...
	public static void main(String arg[])throws IOException{  
		nodo cab=null;
		for(;true;){
			String[] menu1 = {"Agregar nodos","Listado",
			 		 "Sumatoria","Borrar dato de la cabecera",
			 		 "Borrar ultimo nodo","Borrar nodo con dato x",
			 		 "Salir"};
			...
			switch(valor1){
			case "Agregar nodos": cab=agregar_nodo(cab);break;
			case "Listado": listado("Datos de la lista\n",cab);break;
			case "Sumatoria": JOptionPane.showMessageDialog(null, "La sumatoria es "+sumatoria(cab));break;
			case "Borrar dato de la cabecera":cab=borrar_cab(cab); break;
			case "Borrar ultimo nodo":borrar_ultimo(cab);break;
