package widos;
/*Crear  una aplicación Java empleando WINDOWSBUILDER que permita asistir en el control de las entradas y salidas de vehículos de un edificio de parqueo, para tal efecto el sistema debe utilizar un archivo de texto, que contenga:
...
El frame debe permitir :

-          Añadir datos al archivo

-          Emitir un reporte del tiempo utilizado (hh:mm) y el pago por este  tiempo. 
...
Concluida y efectuadas las pruebas necesarias enviar  un archivo comprimido con el nombre: LAB_2_11_18_NOMBRE al corrreo del docente, hasta las 10:30 de hoy viernes 2 de noviembre del 2018.*/
